...
public class ExportBill {
    ...
    public ExportBill(String exportID, String employeeID, String note, String createdBy, int wareHouseID, int statusExport, double totalAmount, Date createdDate, boolean deleted) {
