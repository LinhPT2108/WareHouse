    ...
    public List<Object[]> getTotalProductASC() {
        ...
        try {
            ...
            try {
                ...
                String query = "SELECT * FROM dbo.ThongKeSoLuong ORDER BY SoLuong ASC";
    ...
    public List<Object[]> getTotalProductDESC() {
        ...
        try {
            ...
            try {
                String sql = "{call sp_TKSoLuongSP}";
                XJDBCHelper.executeUpdate(sql);
                String query = "SELECT * FROM dbo.ThongKeSoLuong ORDER BY SoLuong DESC";
                rs = XJDBCHelper.executeQuery(query);
                while (rs.next()) {
                    Object[] model = {
                        rs.getString("MaSP"),
            ...
            try {
                ...
                while (rs.next()) {
                    Object[] model = {
                        ...
                        rs.getString("TenSP"),
                        rs.getInt("SoLuong"),
                        XDateHelper.toString(rs.getDate("NgaySanXuat"), "dd-MM-yyyy"),
        ...
        try {
            ...
            try {
                String sql = """
                            ...
                            FROM    dbo.ChiTietNhap
                                    INNER JOIN dbo.SanPham ON SanPham.MaSP = ChiTietNhap.MaSP
                            WHERE TrangThaiXoa = 0 AND HanSuDung < GETDATE() AND TenSP Like N'%""" + name
                        + """
                          %' GROUP BY ChiTietNhap.MaSP ,
                                    TenSP ,
                                    NgaySanXuat ,
