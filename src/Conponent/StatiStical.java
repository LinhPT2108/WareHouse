...
public class StatiStical extends javax.swing.JPanel {
    ...
    private XExcelHelper excelHelper = new XExcelHelper();
    ...
    public StatiStical(JFrame parent) {
        initComponents();
        this._this = parent;
        init();
    ...
    private void initComponents() {
        ...
        btnSortTP = new CustomSwing.MyButton();
        ...
        btnExportExcel = new CustomSwing.MyButton();
        ...
        btnSortTP.setBackground(new java.awt.Color(215, 249, 250));
        btnSortTP.setForeground(new java.awt.Color(0, 51, 51));
        btnSortTP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/sort (1).png"))); // NOI18N
        btnSortTP.setText("Xếp theo tổng tiền");
        btnSortTP.setColor(new java.awt.Color(215, 249, 250));
        btnSortTP.setColorEntered(new java.awt.Color(157, 234, 238));
        btnSortTP.setColorHover(new java.awt.Color(0, 51, 51));
        btnSortTP.setColorNomal(new java.awt.Color(0, 51, 51));
        btnSortTP.setColorPressed(new java.awt.Color(215, 249, 250));
        btnSortTP.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnSortTP.setIconTextGap(8);
        btnSortTP.setRadius(50);
        btnSortTP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSortTPActionPerformed(evt);
            }
        });
        ...
        pnlSmallTotalProductLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSmallTotalProductLayout.createSequentialGroup()
                ...
                .addComponent(btnSortTP, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33))
        );
        pnlSmallTotalProductLayout.setVerticalGroup(
            ...
            .addGroup(pnlSmallTotalProductLayout.createSequentialGroup()
                ...
                .addGroup(pnlSmallTotalProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnSortTP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(6, 6, 6))
        );

        pnlTotalProduct.add(pnlSmallTotalProduct, java.awt.BorderLayout.PAGE_START);

        spTotalProduct.setVerticalScrollBar(new ScrollBarCustom(12));
        ...
        btnChartRevenue.setBackground(new java.awt.Color(215, 249, 250));
        btnChartRevenue.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnChartRevenue.setColor(new java.awt.Color(215, 249, 250));
        btnChartRevenue.setColorEntered(new java.awt.Color(157, 234, 238));
        btnChartRevenue.setColorHover(new java.awt.Color(0, 51, 51));
        btnChartRevenue.setColorNomal(new java.awt.Color(0, 51, 51));
        btnChartRevenue.setColorPressed(new java.awt.Color(215, 249, 250));
        ...
        spRevenue.setVerticalScrollBar(new ScrollBarCustom(12));
        ...
        btnSortBill.setBackground(new java.awt.Color(215, 249, 250));
        btnSortBill.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnSortBill.setColor(new java.awt.Color(215, 249, 250));
        btnSortBill.setColorEntered(new java.awt.Color(157, 234, 238));
        btnSortBill.setColorHover(new java.awt.Color(0, 51, 51));
        btnSortBill.setColorNomal(new java.awt.Color(0, 51, 51));
        btnSortBill.setColorPressed(new java.awt.Color(215, 249, 250));
        btnSortBill.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnSortBill.setIconTextGap(8);
        ...
        btnExportExcel.setBackground(new java.awt.Color(215, 249, 250));
        btnExportExcel.setForeground(new java.awt.Color(0, 51, 51));
        btnExportExcel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/export_excel.png"))); // NOI18N
        btnExportExcel.setText("Xuất file excel");
        btnExportExcel.setColor(new java.awt.Color(215, 249, 250));
        btnExportExcel.setColorEntered(new java.awt.Color(157, 234, 238));
        btnExportExcel.setColorHover(new java.awt.Color(0, 51, 51));
        btnExportExcel.setColorNomal(new java.awt.Color(0, 51, 51));
        btnExportExcel.setColorPressed(new java.awt.Color(215, 249, 250));
        btnExportExcel.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnExportExcel.setIconTextGap(8);
        btnExportExcel.setRadius(50);
        ...
        pnlSmallBillLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSmallBillLayout.createSequentialGroup()
                ...
                .addComponent(btnExportExcel, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        spImportBill.setVerticalScrollBar(new ScrollBarCustom(12));
        ...
        tblImportBill.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Tổng tiền (VND)", "Trạng thái", "Mã nhân viên", "Ngày tạo"
            }
        ) {
            Class[] types = new Class [] {
        ...
        btnSortExpiry.setBackground(new java.awt.Color(215, 249, 250));
        btnSortExpiry.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnSortExpiry.setColor(new java.awt.Color(215, 249, 250));
        btnSortExpiry.setColorEntered(new java.awt.Color(157, 234, 238));
        btnSortExpiry.setColorHover(new java.awt.Color(0, 51, 51));
        btnSortExpiry.setColorNomal(new java.awt.Color(0, 51, 51));
        btnSortExpiry.setColorPressed(new java.awt.Color(215, 249, 250));
        ...
        spExpiry.setVerticalScrollBar(new ScrollBarCustom(12));
        ...
        tblExpiry.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Sản Phẩm", "Tên Sản Phẩm", "Số lượng", "Ngày sản xuất", "Ngày hết hạn"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
        ...
        tabContainer.addTab("Sản Phẩm Hết Hạn", pnlExpiry);
    ...
    private void btnExportExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelActionPerformed
        excelHelper.exportExcel(_this, tblImportBill,cboTypeBill.getSelectedItem().toString(), 1);
    }//GEN-LAST:event_btnExportExcelActionPerformed

    private void btnSortTPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortTPActionPerformed
        if(checkTotalProduct){
            fillToTableTP(sDAO.getTotalProductDESC());
            checkTotalProduct = !checkTotalProduct;
        }else{
            fillToTableTP(sDAO.getTotalProductASC());
            checkTotalProduct = !checkTotalProduct;
        }
    }//GEN-LAST:event_btnSortTPActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.ButtonGroup bgpBill;
    private CustomSwing.MyButton btnChartRevenue;
    private CustomSwing.MyButton btnExportExcel;
    private CustomSwing.MyButton btnSortBill;
    private CustomSwing.MyButton btnSortExpiry;
    private CustomSwing.MyButton btnSortTP;
    ...
    public void fillToTableTP(List<Object[]> listTP) {
        DefaultTableModel model = (DefaultTableModel) tblTotalProduct.getModel();
        model.setRowCount(0);
        for (Object object : listTP) {
