...
public class SupplierUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        spSupplier.setVerticalScrollBar(new ScrollBarCustom(12));
    ...
    void deleteSupplier() {
        ...
        try {
            ...
            for (Object[] objects : listP) {
                if (txtSupplierID.getText().equalsIgnoreCase(pDAO.selectById(String.valueOf(objects[0])).getSupplierID())) {
