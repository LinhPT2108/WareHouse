...
public class ProductUI extends javax.swing.JPanel {
    ...
    XExcelHelper excel = new XExcelHelper();
    ...
    private void initComponents() {
        ...
        btnExportExcel.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        ...
        btnExportExcel.setText("Xuất File");
        ...
        btnImportExcel.setBackground(new java.awt.Color(215, 249, 250));
        btnImportExcel.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        btnImportExcel.setForeground(new java.awt.Color(0, 51, 51));
        btnImportExcel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/excel.png"))); // NOI18N
        btnImportExcel.setText("Nhập File");
        ...
        btncreateProduct.setBackground(new java.awt.Color(215, 249, 250));
        btncreateProduct.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        btncreateProduct.setForeground(new java.awt.Color(0, 51, 51));
        btncreateProduct.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/add-product.png"))); // NOI18N
        btncreateProduct.setText("Tạo SP mới");
        ...
        pnlSmallListLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSmallListLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(txtFindProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
        ...
        pnlSmallListLayout.setVerticalGroup(
            ...
            .addGroup(pnlSmallListLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlSmallListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlSmallListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtFindProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btnSortProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlSmallListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblProduct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ SP", "NCC", "TÊN SP", "HÌNH ẢNH", "LOẠI SP", "ĐƠN GIÁ BÁN (VND)", "ĐƠN VỊ TÍNH"
            }
        ) {
        ...
        lblPrice1.setText("Đơn giá bán (VND):");
        ...
        pnlBottomLayout.setHorizontalGroup(
            ...
            .addGroup(pnlBottomLayout.createSequentialGroup()
                ...
                .addGroup(pnlBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(spNote, javax.swing.GroupLayout.PREFERRED_SIZE, 944, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(pnlBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(lblNote1, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnExportExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelActionPerformed
        ...
        if (tblProduct.getRowCount() > 1) {
            excel.exportExcel(_this, tblProduct, "Sản Phẩm", 5);
        } else {
            XDialogHelper.alert(this, "Danh sách không có dữ liệu !");
        }
    ...
    public void importExcel() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                String url = "jdbc:sqlserver://localhost:1433;databaseName=KhoVatTu";
                String user = "sa";
                String password = "123";
                Connection conn = DriverManager.getConnection(url, user, password);
                // Duyệt qua các dòng trong file Excel và thêm vào cơ sở dữ liệu
                while (rowIterator.hasNext()) {
                    ...
                    String supplierName = "";
                    if (cell1 != null) {
                        supplierName = cell1.getStringCellValue();
                    }
                    ...
                    String productImage = "";
                    if (cell3 != null) {
                        productImage = cell3.getStringCellValue();
                    }

                    Cell cell4 = row.getCell(4);
                    String productType = "";
                    if (cell4 != null) {
                        productType = cell4.getStringCellValue();
                    }

                    Cell cell5 = row.getCell(5);
                    double productPrice = 0;
                    if (cell5 != null) {
                        productPrice = cell5.getNumericCellValue();
                    }

                    Cell cell6 = row.getCell(6);
                    String productUnit = "";
                    if (cell6 != null) {
                        productUnit = cell6.getStringCellValue();
                    }

                    if (productName.equals("") || supplierName.equals("") || productType.equals("") || supplierName.equals("") || productPrice == 0 || productUnit.equals("")) {

                    } else {

                        String supplierID = spDAO.selectByName(supplierName).getSupplierID();
                        int unitID = unDAO.selectByName(productUnit).getUnitID();
                        int pdType = Integer.parseInt(tyDAO.selectByName(productType).getProductTypeID());
                        ...
                        String checkProductQuery = "SELECT * FROM SanPham WHERE TenSP = ?";
                        PreparedStatement checkProductStatement = conn.prepareStatement(checkProductQuery);
                        checkProductStatement.setString(1, productName);
                        ...
                        if (!checkProductResult.next()) {
                            ...
                            String insertProductQuery
                                    = "Insert into dbo.SanPham( MaSP ,MaNCC ,TenSP ,HinhAnh ,LoaiSP ,DonGiaBan ,DonViTinh, NguoiTao) "
                                    + "VALUES(?,?,?,?,?,?,?,?)";
                            PreparedStatement insertProductStatement = conn.prepareStatement(insertProductQuery);
                            insertProductStatement.setString(1, BaseDAO.setExportID("SanPham", "SP", 6));
                            insertProductStatement.setString(2, supplierID);
                            insertProductStatement.setString(3, productName);
                            insertProductStatement.setString(4, productImage);
                            insertProductStatement.setInt(5, pdType);
                            insertProductStatement.setDouble(6, productPrice);
                            insertProductStatement.setInt(7, unitID);
                            insertProductStatement.setString(8, Auth.user.getEmployeeID());
...
//                 Load lại dữ liệu lên JTable
                ...
                XDialogHelper.alert(this, "Nhập " + index + " Sản Phẩm mới thành công!");
                conn.close();
            } catch (IOException | NumberFormatException | SQLException ex) {
                System.out.println(ex);
                XDialogHelper.alert(this, "Nhập Sản Phẩm thất bại!");
            }
...
//            JLabel lbl = new JLabel(imageIcon);
    ...
    void chooseImg() {
        if (fileChooser.showOpenDialog(_this)) {
            ...
            if (file.getName().endsWith(".jpg") || file.getName().endsWith(".png")) {
                XShareHelper.saveLogo(file, txtProductID.getText() + "-"+txtProductName.getText());
                
                int indexLastExtension = file.getAbsolutePath().lastIndexOf(".");
                String extensionFile = file.getAbsolutePath().substring(indexLastExtension);
                lblImage.setIcon(XShareHelper.scaledImage(txtProductID.getText() + "-"+txtProductName.getText()+extensionFile, lblImage));
                lblImage.setToolTipText(txtProductID.getText() + "-"+txtProductName.getText()+extensionFile);
            } else {
    ...
    void setForm(Product pd) {
        ...
        txtDateCreated.setText(XDateHelper.toString(pd.getCreateDate(), "dd-MM-yyyy"));
    ...
    private void deleteProduct() {
        ...
        try {
            if (XDialogHelper.confirm(this, "Xóa Sản Phẩm đang chọn ?")) {
                List<Object[]> listP = sDAO.getTotalProductDESC();
                for (Object[] objects : listP) {
                    if (txtProductID.getText().equalsIgnoreCase(String.valueOf(objects[0]))) {
                        if (Integer.parseInt(String.valueOf(objects[2])) > 0) {
                            checkDelete = false;
                            break;
                        }
                    }
                ...
                if (checkDelete) {
                    ...
                    XDialogHelper.alert(this, "Xoá thất bại, vẫn còn sản phẩm trong kho !");
                }
            }
