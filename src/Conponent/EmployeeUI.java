...
public class EmployeeUI extends javax.swing.JPanel {
    ...
    public EmployeeUI(JFrame Jframe, JLabel avt) {
        initComponents();
        this.Jframe = Jframe;
    ...
    private void initComponents() {
        ...
        btnClear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/rotation.png"))); // NOI18N
        ...
        spEmployee.setVerticalScrollBar(new ScrollBarCustom(10)
        );
    ...
    void chooseImg() {
        if (fileChooser.showOpenDialog(this.Jframe)) {
            ...
            if (file.getName().endsWith(".jpg") || file.getName().endsWith(".png")) {
                XShareHelper.saveLogo(file, txtEmployeeID.getText() + "-" + txtName.getText());
                ...
                lblmage.setIcon(XShareHelper.scaledImage(txtEmployeeID.getText() + "-" + txtName.getText()+extensionFile, lblmage));
                lblmage.setToolTipText(txtEmployeeID.getText() + "-" + txtName.getText()+extensionFile);
            } else {
    ...
    private void updateEmployee() {
        ...
        try {
            if (XDialogHelper.confirm(this, "Cập nhật Nhân Viên đang chọn ?")) {
                elDAO.update(e);
                this.fillTableEmployee(elDAO.select());
                if (Auth.user.getEmployeeID().equals(txtEmployeeID.getText())) {
                    avt.setIcon(XShareHelper.scaledImage(e.getImage(), avt));
                }
                this.clearForm();
